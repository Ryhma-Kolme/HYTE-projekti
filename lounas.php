        ...
        <div class="column">
            ...
            <div class="column-content">
                <?php // userID lisäys 
                    ...
                    // Kellon aika  (esim. 19:41:37) lisätään clickedDay:hin
                ...
                <?php // Poistaa kaikki tämän päivän lounaat "Poista kaikki"-napista

                    if(isset($_POST['lunch_deletebtn'])){

                        // Näytetään vain kirjautuneen käyttäjän ja tämän päivän lisätyt ruoka-aineet
                        $sql="DELETE FROM app_lunch WHERE DATE(`timeOfEating`) = '$clickedDay' AND userID = '$currentUserID' ORDER BY timeOfEating ASC";
                    ...
                    if(isset($_POST['foodbtn'])){
                        ...
                        if ($selected_val==NULL) {
                            ...
                            echo("<h2>Et ole lisännyt ruoan määrää. Lisää määrä ennen tallentamista. </h2>");               
                                ...
                                $STH = $DBH->prepare("INSERT INTO app_lunch 
                ...
                <?php // Syötetään arvot taulukkoon
                    ...
                    // Näytetään vain kirjautuneen käyttäjän ja tämän päivän lisätyt ruoka-aineet
                    $sql="SELECT * FROM app_lunch WHERE DATE(`timeOfEating`) = '$clickedDay' AND userID = '$currentUserID' ORDER BY timeOfEating ASC";
                    $kysely=$DBH->prepare($sql);				
                    $kysely->execute();
